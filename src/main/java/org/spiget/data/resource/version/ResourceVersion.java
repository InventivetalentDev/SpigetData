...
public class ResourceVersion extends ListedResourceVersion {
    ...
    public static UUID makeUuid(int resourceId, int authorId, String versionName, int updateCount, Date date) {
        ...
        String stringA = "16" + Util.trim("" + authorId, 6) + "" + Util.trim("" + resourceId, 6) + "" + Util.trim(Util.pad(versionNameNumber, 5), 5);
        String stringB = "16" + Util.trim("" + resourceId, 6) + "" + dateString + "" + Util.trim(Util.pad(updateCount, 2), 3);
